(function (root) {
  ...
  function readingGuideHTML(page, rootPath) {
    ...
    return '<section class="spot-page-section spot-reading-guide"><h2>' + (compact ? '<span class="copy-chunk">' + escapeHTML(page.name) + 'を</span><span class="copy-chunk">見逃さないために</span>' : escapeHTML(page.name) + 'を見逃さないために') + '</h2><div class="spot-reading-actions">' +
