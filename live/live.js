...
(function () {
  ...
  var STR = {
    ja: {
      ...
      idleNoGps: "乗車前でも「デモ走行」で東京〜新大阪の案内をひととおり試せます。位置情報の許可は不要です。",
    ...
    en: {
      ...
      idleNoGps: "Not on board yet? The demo run plays the whole Tokyo-Shin-Osaka guide without asking for your location.",
