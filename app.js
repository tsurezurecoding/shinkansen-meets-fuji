...
const MSG = {
  ja: {
    ...
    seoEntryEyebrow: "WINDOW GUIDE",
    seoEntryTitle: "主要な車窓の見つけ方",
    seoEntrySub: "富士山、浜名湖、城、東寺、車両基地。検索から来た人も、乗る前にすぐ確認できる入口です。",
    seoFujiName: "富士山",
    seoFuji: "見える時間とE席側",
    seoLeftFujiName: "左富士",
    seoLeftFuji: "A席側に一瞬見える富士山",
    seoHamanakoName: "浜名湖",
    seoHamanako: "A席とE席で違う水辺の景色",
    seoOdawaraCastleName: "小田原城",
    seoOdawaraCastle: "のぞみでは一瞬の城",
    seoTojiName: "東寺 五重塔",
    seoToji: "京都駅前後の合図",
    seoTorikaiName: "鳥飼車両基地",
    seoTorikai: "新大阪手前の車両基地",
    seoKiyosuName: "清洲城",
    seoKiyosu: "線路近くの城",
    seoHikoneName: "彦根城",
    seoHikone: "街の向こうの国宝天守",
    seoSolarArkName: "ソーラーアーク",
    seoSolarArk: "巨大な太陽の船",
  ...
  en: {
    ...
    seoEntryEyebrow: "WINDOW GUIDE",
    seoEntryTitle: "How to find the major views",
    seoEntrySub: "Mt. Fuji, Lake Hamana, castles, To-ji, and a Shinkansen depot: quick readable guides before you board.",
    seoFujiName: "Mt. Fuji",
    seoFuji: "When to see it, and Seat E",
    seoLeftFujiName: "Left-Side Fuji",
    seoLeftFuji: "A brief Fuji view from Seat A",
    seoHamanakoName: "Lake Hamana",
    seoHamanako: "Different water views from Seats A and E",
    seoOdawaraCastleName: "Odawara Castle",
    seoOdawaraCastle: "A blink-and-you-miss-it castle",
    seoTojiName: "To-ji Pagoda",
    seoToji: "The Kyoto arrival signal",
    seoTorikaiName: "Torikai Train Depot",
    seoTorikai: "The depot before Shin-Osaka",
    seoKiyosuName: "Kiyosu Castle",
    seoKiyosu: "A castle close to the tracks",
    seoHikoneName: "Hikone Castle",
    seoHikone: "A National Treasure beyond town",
    seoSolarArkName: "Solar Ark",
    seoSolarArk: "A giant solar ship",
