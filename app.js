...
const MSG = {
  ja: {
    ...
    btnReset: "スタンプをリセット",
    galEyebrow: "FIELD GUIDE", galTitle: "車窓図鑑",
    galDiscovery: "<span class=\"copy-chunk\">知ると、</span><span class=\"copy-chunk\">車窓はもっと面白い。</span>",
    galSub: "<span class=\"copy-chunk\">見慣れた看板の正体も、</span><span class=\"copy-chunk\">富士山と工場のつながりも。</span><span class=\"copy-chunk\">写真と解説で知ると、</span><span class=\"copy-chunk\">次に窓を見る楽しみが増えます。</span>",
  ...
  en: {
    ...
    galEyebrow: "FIELD GUIDE", galTitle: "Shinkansen Window Field Guide",
    galDiscovery: "Get to know the sights. Enjoy the view even more.",
    galSub: "What are those signs? Why are there paper mills below Mt. Fuji? Explore the photos and stories, then look out for the details on your next ride.",
