...
expect(englishStart.includes('data-cta-id="top_journey_727"') && englishStart.includes('data-cta-id="top_footer_727"') && englishStart.includes('href="en/zukan.html?filter=sign#gallery"'), "en/start.html: English 727 Collection links must remain available");
