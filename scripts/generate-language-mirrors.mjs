...
function localizeEnglishRail(html) {
  const copy = [
    ...
    ["富士山を見る", "See Mt. Fuji"],
    ["5つの区間、座席側、曇りの日の見え方を確認。", "Check the timing, seat side, and what to expect on cloudy days."],
    ["見える予報β", "Visibility β"],
  ...
  const arenaniCard = `        <a class="journey-intent-card journey-intent-cloudy" href="en/arenani.html" data-cta-track="zukan_theme_click" data-cta-id="arenani">
          ...
          <span class="journey-intent-copy">
            ...
            <span>Tea fields, paper mills and a giant red gate — start with what caught your eye.</span>
          </span>
        </a>`;
