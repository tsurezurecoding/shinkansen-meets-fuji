...
const GUIDE_RAIL_LOCALIZATION = {
  "zh-Hant": {
    ...
    spots: {
      ...
      "nonhoi-park-wheel": "豐橋綜合動植物公園摩天輪", "laguna-wheel": "蒲郡拉古娜摩天輪", "horiuchi-park-wheel": "安城堀內公園摩天輪",
  ...
  "zh-Hans": {
    ...
    spots: {
      ...
      "nonhoi-park-wheel": "丰桥综合动植物公园摩天轮", "laguna-wheel": "蒲郡拉古娜摩天轮", "horiuchi-park-wheel": "安城堀内公园摩天轮",
  ...
  ko: {
    ...
    spots: {
      ...
      "nonhoi-park-wheel": "논호이 파크 대관람차", "laguna-wheel": "라구나 텐보스 대관람차", "horiuchi-park-wheel": "호리우치 공원 대관람차",
  ...
  fr: {
    ...
    spots: {
      ...
      "nonhoi-park-wheel": "Grande roue du parc Nonhoi", "laguna-wheel": "Grande roue de Laguna Ten Bosch", "horiuchi-park-wheel": "Grande roue du parc Horiuchi",
  ...
  de: {
    ...
    spots: {
      ...
      "nonhoi-park-wheel": "Riesenrad im Nonhoi-Park", "laguna-wheel": "Riesenrad von Laguna Ten Bosch", "horiuchi-park-wheel": "Riesenrad im Horiuchi-Park",
  ...
  es: {
    ...
    spots: {
      ...
      "nonhoi-park-wheel": "Noria del parque Nonhoi", "laguna-wheel": "Noria de Laguna Ten Bosch", "horiuchi-park-wheel": "Noria del parque Horiuchi",
