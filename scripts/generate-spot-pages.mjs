...
function englishLandingHTML() {
  ...
  html = html.replaceAll("<span class=\"copy-chunk\">いつもの車窓を、</span><span class=\"copy-chunk\">再発見。</span>", "<span class=\"copy-chunk\">何度も乗るなら、</span><span class=\"copy-chunk\">車窓スタンプを集める。</span>");
