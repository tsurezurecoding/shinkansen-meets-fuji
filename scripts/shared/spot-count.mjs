...
const NOT_A_CLAIM = [
  ...
  "新大阪まで#区間に分けて",
  // 富士山ガイド（GUIDE-CTR-0913）の「5つの区間」と区間番号は、富士山が見える区間の数と番号。景の数ではない。
  "富士山會在#個區間出現", "#個區間中有", "區間中有#個擁有", "區間#的前景",
  "富士山会在#个区间出现", "#个区间中有", "区间中有#个拥有", "区间#的前景",
  "후지산은 #개 구간에서", "#개 구간 중", "구간 중 #곳에는", "구간 #의 앞 풍경", "약 #분 반 동안",
];
