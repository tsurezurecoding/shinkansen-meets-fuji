...
const BOARD_COLLECTION = [
  ...
  { sourceNo: 33, id: "727-no-33", minutesFromTokyo: 99, segment: "名古屋 → 岐阜羽島", side: "E", lat: 35.250719, lng: 136.769991, confidence: "needs-check", photo: { src: "images/20260712_727_board_hirahachinotsubo_michikusa.jpg", alt: "車窓から見える稲沢市平蜂ノ坪町の727看板", note: "michikusa / 2026-07-12 · 上り列車から、清洲城の約2分前に撮影" }, ja: "平蜂ノ坪町（稲沢市）", en: "Hirabachinotsubo, Inazawa" },
  ...
  { sourceNo: 37, id: "727-no-37", minutesFromTokyo: 107, segment: "岐阜羽島 → 米原", side: "E", lat: 35.362859, lng: 136.535071, collectionNote: "ストリートビューで確認", confidence: "needs-check", ja: "宮代（垂井町）", en: "Miyashiro, Tarui" },
