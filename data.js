  ...
  },
  {
    ...
    explainer: {
      ...
      ja: [
        ...
        "本来は東海道本線側や、名鉄各務原線側から近く見えます。ページ内の掲載写真も参考として東海道本線側からの記録を使っています。実際に「大きく見える岐阜城」を楽しみたい場合は、乗り継ぎで訪れる価値がある城です。",
      ],
      en: [
        ...
        "The castle is much more prominent from the Tokaido Main Line and the Meitetsu Kakamigahara Line. The reference photo used on this page is taken from those directions. If you want to see Gifu Castle up close, it is well worth a connecting trip.",
      ],
    },
    guideHighlight: {
    ...
    references: [REFERENCES.gifuCastleOfficial, REFERENCES.gifuCastleBlog],
