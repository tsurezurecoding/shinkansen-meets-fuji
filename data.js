...
const SPOTS = [
  ...
  },
  {
    ...
    en: { name: "Hikone Castle", area: "Maibara → Kyoto", hook: "A National Treasure keep, tiny beyond the town.", story: "After Maibara, Hikone Castle's keep may appear small beyond the town on the Seat E side. It is not a big, obvious view; that is what makes spotting it satisfying. For a few seconds, the history of eastern Lake Biwa enters the window." },
