...
const SPOTS = [
  ...
  },
  {
    id: "fuji-bus-sales",
    icon: "🚌",
    ja: { name: "富士バス販売", area: "三島 → 新富士（富士市川成島）", hook: "窓の下に、バスの大行列。", story: "E席側の富士山がいよいよ大きくなるころ、反対のA席側にはバスが何列も並ぶ展示場が現れます。ここは富士バス販売。大型観光バスからマイクロバスまでを扱う中古バスの専門店です。山が雲に隠れた日も、白い車体の列が窓いっぱいに広がります。" },
    en: { name: "Fuji Bus Sales", area: "Mishima → Shin-Fuji, Fuji City", hook: "Rows and rows of buses.", story: "As Mt. Fuji reaches its grandest view from Seat E, turn to Seat A for a different spectacle: row after row of buses below the tracks. This is Fuji Bus Sales, a dealer in used buses from full-size coaches to minibuses. The buses are there to enjoy even when clouds hide the mountain." },
    ...
    pageStory: { ja: "東京から西へ向かう新幹線が新富士に近づくころ、A席側の高架下に白いバスが何列も現れます。写真には「富士バス販売 第三展示場」の看板も写っています。2026年9月19日のこだま815号から撮った2枚では、約3秒のあいだにバス列の違う部分が窓を横切りました。E席側で富士山を追う時間帯と重なるため、こちらを見たい人はA席側へ。", en: "Approaching Shin-Fuji from Tokyo, look down from Seat A for several rows of mostly white buses. One of our photographs even catches a sign reading 'Fuji Bus Sales, Third Display Yard.' Two frames from Kodama 815 on 19 September 2026 show different parts of the yard passing the window less than three seconds apart. This view arrives while Seat E passengers are watching Mt. Fuji, so choose the A side if the buses are your goal." },
    explainer: {
      heading: { ja: "走る前のバスが並ぶ場所", en: "A place for buses between journeys" },
      ja: [
        "富士バス販売は、富士市川成島にある中古バスの販売・買取会社です。公式サイトでは大型の観光・送迎・路線バスから中型、小型、マイクロバスまでを扱い、在庫車両を自社に置くと案内しています。車窓に見える白い車体の列は、駐車場にたまたまバスが集まったものではなく、次の持ち主を待つ展示場の景色です。",
        "写真を見比べると、同じ白いバスでも長さや窓の並び、車体の形が違います。ふだんは一台ずつ道路で出会う乗り物が、ここでは一度に何列も見える。その数と並び方が、この短い車窓の面白さです。撮影時の配置は変わり得るので、特定の一台を探すよりバスの列全体を目印にしてください。",
        "E席側の富士山が雲に隠れても、A席側の展示場は近くにはっきり見えます。田子の浦港から展示場までを撮った車窓動画では、港の景色からバスの列へ変わっていく流れも追えます。山を見る日とは別の富士市の表情を、数秒だけ窓から眺めてください。",
      ],
      en: [
        "Fuji Bus Sales is a used-bus dealer in Kawanarijima, Fuji City. Its official website lists full-size sightseeing, shuttle and route buses as well as medium and smaller vehicles, including minibuses, and says its stock is kept on site. The white rows in the window are a display yard where vehicles wait for their next owners.",
        "Look closely at the two photos: even among the white buses, lengths, window patterns and body shapes differ. A vehicle you normally meet one at a time on the road appears here in several rows at once. The exact stock and arrangement can change, so look for the overall pattern rather than a particular bus.",
        "The yard is close enough to enjoy when cloud cover spoils the Seat E view of Mt. Fuji. The window video follows the Seat A scenery from Tagonoura Port to the bus yard, showing another side of Fuji City in the few seconds the buses pass.",
      ],
    },
    ...
    references: [{ label: { ja: "富士バス販売：会社概要", en: "Fuji Bus Sales: company profile (Japanese)" }, url: "https://www.fujibus-sales.co.jp/company.php" }, { label: { ja: "富士バス販売：取扱車両", en: "Fuji Bus Sales: types of buses (Japanese)" }, url: "https://www.fujibus-sales.co.jp/" }],
