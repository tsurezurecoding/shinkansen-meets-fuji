...
const SPOTS = [
  ...
  },
  {
    ...
    icon: "🏭",
    ja: { name: "サッポロビール静岡工場", area: "静岡 → 掛川（焼津付近）", hook: "銀のタンクが、窓に並ぶ。", story: "静岡を出て焼津へ向かう途中、A席側に銀色の大きなタンクがずらりと現れます。サッポロビール静岡工場です。清洲城の近くで見えるキリンビール名古屋工場は車窓の有名な工場ですが、こちらもタンク列が近く、通り過ぎる一瞬に迫力があります。" },
    en: { name: "Sapporo Beer Shizuoka Brewery", area: "Shizuoka → Kakegawa, near Yaizu", hook: "A row of silver tanks flashes by.", story: "Soon after Shizuoka, a row of large silver tanks passes the Seat A window near Yaizu. This is Sapporo Beer's Shizuoka brewery. The Kirin brewery near Kiyosu Castle is a better-known train-window landmark, but these tanks make an equally striking close-up view." },
    pageTitle: { ja: "新幹線から見えるサッポロビール静岡工場｜焼津のタンク列 | 新幹線の窓", en: "Sapporo Beer Shizuoka Brewery from the Shinkansen | Tanks near Yaizu" },
    pageHeading: { ja: "焼津の車窓に並ぶ、サッポロのタンク", en: "Sapporo's tanks beside the tracks near Yaizu" },
    pageHeadingChunks: { ja: ["焼津の車窓に並ぶ、", "サッポロのタンク"], en: ["Sapporo's tanks", "beside the tracks near Yaizu"] },
    metaDescription: { ja: "静岡駅を出て焼津へ向かう新幹線のA席側に見える、サッポロビール静岡工場のタンク列。撮影位置と見つけ方を紹介します。", en: "Spot the row of silver tanks at Sapporo Beer's Shizuoka brewery from Seat A, shortly after Shizuoka Station toward Yaizu." },
    sectionHeading: { ja: "この銀色のタンクはどこの工場？", en: "Whose tanks are these?" },
    pageStory: { ja: "静岡駅を出て西へ進み、焼津市浜当目のあたりでA席側を見てください。線路のすぐ近くに丸い屋根を載せたタンクが連なり、その後ろにサッポロの星印が見えます。2026年9月4日の下り列車から撮影した写真では、タンクが窓いっぱいに並びました。", en: "Watch Seat A as the train heads west from Shizuoka toward Yaizu. Close to the tracks, tanks with rounded tops stand in a long row, with Sapporo's star visible behind them. A photograph taken from a westbound train on 4 September 2026 shows just how much of the window they fill." },
    explainer: { heading: { ja: "もうひとつのビール工場の車窓", en: "Another brewery view from the train" }, ja: ["サッポロビール静岡工場は焼津市浜当目にあります。清洲城のそばにあるキリンビール名古屋工場のタンク列も人気ですが、静岡から西へ向かうこの区間にも、見逃したくない工場の景色があります。", "写真で分かるのは工場の外観とタンク列です。個々のタンクの用途や製造工程は、外から見ただけでは特定できません。"], en: ["Sapporo Beer's Shizuoka brewery stands in Hamatome, Yaizu. The tank row at Kirin's Nagoya brewery near Kiyosu Castle is a familiar landmark, yet this stretch west of Shizuoka has an industrial view worth catching too.", "The photograph identifies the brewery and its row of tanks. Their individual contents or roles cannot be determined from the train window alone."] },
    guideHighlight: { ja: "静岡を出たらA席側に注目。星印の建物と銀色のタンク列が目印です。", en: "After Shizuoka, watch Seat A for the star-marked building and the line of silver tanks." },
    minutesFromTokyo: 56, side: "A", category: "notable", confidence: "verified", durationSec: 10, spotting: "easy", scene: "solar", visibleWhenCloudy: true,
    ...
    references: [{ label: { ja: "サッポロビール：製造所所在地", en: "Sapporo Beer: brewery location (Japanese)" }, url: "https://www.sapporobeer.jp/info/0000011924/" }],
  ...
  },
  {
    ...
    icon: "🏭",
    ja: { name: "洛西浄化センターの卵形タンク", area: "京都 → 新大阪（長岡京付近）", hook: "窓の先に、巨大なたまご。", story: "京都を出て何気なくA席側を眺めていると、巨大なたまねぎのような構造物が二つ流れ去ります。あれは何？と思った人も多いはず。長岡京市の洛西浄化センターにある卵形の汚泥消化タンクです。" },
    en: { name: "Rakusai's Egg-Shaped Digestion Tanks", area: "Kyoto → Shin-Osaka, near Nagaokakyo", hook: "Two giant eggs beside the tracks.", story: "After Kyoto, two enormous onion-shaped structures flash past the Seat A window. They belong to the Rakusai wastewater treatment centre in Nagaokakyo: egg-shaped tanks used to digest sewage sludge." },
    pageTitle: { ja: "新幹線から見える洛西浄化センターの卵形汚泥消化タンク | 新幹線の窓", en: "Rakusai's Egg-Shaped Sludge Digestion Tanks from the Shinkansen" },
    pageHeading: { ja: "あの巨大なたまごは何？ 洛西浄化センター", en: "What are those giant eggs? Rakusai's digestion tanks" },
    pageHeadingChunks: { ja: ["あの巨大なたまごは何？", "洛西浄化センター"], en: ["What are those giant eggs?", "Rakusai's digestion tanks"] },
    metaDescription: { ja: "京都を出た新幹線のA席側に見える二つの卵形タンク。長岡京市の洛西浄化センターで下水汚泥を処理する施設を、車窓写真とともに紹介します。", en: "The two egg-shaped tanks visible from Seat A after Kyoto are part of the Rakusai wastewater treatment centre in Nagaokakyo." },
    sectionHeading: { ja: "たまご形の建物の正体は？", en: "Why are the tanks egg-shaped?" },
    pageStory: { ja: "京都駅を出て新大阪へ向かうと、長岡京市のあたりでA席側に二つの大きな卵形タンクが並びます。低い建物の上にふくらんだ輪郭が突然現れ、新幹線の速さであっという間に後ろへ消えます。2026年9月19日の下り列車から、卵形の二基と隣の設備を撮影しました。", en: "On the way from Kyoto to Shin-Osaka, two large egg-shaped tanks rise beside the tracks near Nagaokakyo. Their rounded silhouettes suddenly emerge above the low buildings, then disappear almost at once. A westbound train photograph from 19 September 2026 shows the pair and the surrounding treatment works." },
    explainer: { heading: { ja: "汚泥を消化するタンク", en: "Tanks that digest sludge" }, ja: ["洛西浄化センターは、京都府が運営する下水処理施設です。京都府の施設資料には卵形の汚泥消化タンクが二槽あり、下水処理で生じた汚泥を内部で消化すると記されています。", "卵形はただの飾りではありません。汚泥がたまりにくく、内部をかき混ぜやすい形として採用されています。車窓で見える独特の形には、処理施設としての理由があります。"], en: ["Rakusai is a wastewater treatment centre operated by Kyoto Prefecture. Its facility specification lists two egg-shaped sludge digestion tanks, which process sludge produced during wastewater treatment.", "The shape has a practical role: it helps mixing and limits places where sludge can collect. The distinctive silhouette is part of the engineering of the treatment works."] },
    guideHighlight: { ja: "京都を出たらA席側を見てください。東寺のあと、低い建物の上に二つの卵形が急に現れます。", en: "Watch Seat A after Kyoto. Beyond To-ji, two rounded tanks rise suddenly above the lower buildings." },
    minutesFromTokyo: 132, side: "A", category: "curious", confidence: "verified", durationSec: 8, spotting: "easy", scene: "solar", visibleWhenCloudy: true,
