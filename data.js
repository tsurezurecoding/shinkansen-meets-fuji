...
const REFERENCES = {
  ...
  nonhoiAmusement: {
    label: { ja: "のんほいパーク: 遊園地ゾーン（大観覧車）", en: "Nonhoi Park: the amusement zone and its Ferris wheel (Japanese only)" },
    url: "https://www.nonhoi.jp/amusement/",
  },
  nonhoiParkOfficial: {
    label: { ja: "のんほいパーク（豊橋総合動植物公園）公式サイト", en: "Nonhoi Park (Toyohashi Zoo and Botanical Park) official site (Japanese only)" },
    url: "https://www.nonhoi.jp/",
  },
  nonhoiParkWiki: {
    label: { ja: "Wikipedia: 豊橋総合動植物公園", en: "Wikipedia: Toyohashi Zoo and Botanical Park (Japanese only)" },
    url: "https://ja.wikipedia.org/wiki/%E8%B1%8A%E6%A9%8B%E7%B7%8F%E5%90%88%E5%8B%95%E6%A4%8D%E7%89%A9%E5%85%AC%E5%9C%92",
  },
  lagunasiaOfficial: {
    label: { ja: "ラグーナテンボス: ラグナシア（高さ65mの観覧車）", en: "Laguna Ten Bosch: Lagunasia and its 65-metre Ferris wheel (Japanese only)" },
    url: "https://www.lagunatenbosch.co.jp/lagunasia/index.html",
  },
  lagunasiaWiki: {
    label: { ja: "Wikipedia: ラグナシア", en: "Wikipedia: Lagunasia (Japanese only)" },
    url: "https://ja.wikipedia.org/wiki/%E3%83%A9%E3%82%B0%E3%83%8A%E3%82%B7%E3%82%A2",
  },
  horiuchiParkAnjo: {
    label: { ja: "安城市: 堀内公園", en: "Anjo City: Horiuchi Park (Japanese only)" },
    url: "https://www.city.anjo.aichi.jp/tanoshimu/koen/horiuchi.html",
  },
  horiuchiParkAichiNow: {
    label: { ja: "Aichi Now（愛知県公式観光サイト）: 堀内公園", en: "Aichi Now, the prefecture's official tourism site: Horiuchi Park (Japanese only)" },
    url: "https://aichinow.pref.aichi.jp/spots/detail/2472/",
  },
};
...
const SPOTS = [
  ...
  },
  {
    ...
    minutesFromTokyo: 27, side: "E", category: "notable", confidence: "verified", durationSec: 3, spotting: "moderate", visibleWhenCloudy: true, scene: "hills",
  ...
  },
  {
    ...
    minutesFromTokyo: 14, side: "E", category: "notable", confidence: "verified", durationSec: 8, spotting: "easy", visibleWhenCloudy: true, scene: "hills",
  ...
  },
  {
    ...
    minutesFromTokyo: 23, side: "E", category: "curious", confidence: "verified", durationSec: 2, spotting: "hard", visibleWhenCloudy: true, scene: "hills",
  ...
  },
  {
    ...
    explainer: {
      ...
      ja: [
        ...
        "トンネルが多いのは、この区間で山がそのまま海へ落ちているからです。箱根の火山体から続く斜面は平地をほとんど残さずに海岸へ達し、線路を通せる平らな土地がありません。だから新幹線は山側を掘って進み、谷が海へ開ける場所でだけ外の光が入ります。海が途切れて見えるのは演出ではなく、地形そのものがこの車窓のリズムを決めているからです。",
      ],
      en: [
        ...
        "The tunnels exist because the mountains here drop straight into the sea. Slopes descending from the Hakone volcanic complex reach the shore with almost no flat land left, so there is no level ground for a railway. The Shinkansen therefore runs inside the hillside and admits daylight only where a valley opens toward the water. The broken view is not a matter of scenery but of terrain: the landform sets the rhythm of this window.",
      ],
    },
    guideHighlight: {
    ...
    minutesFromTokyo: 36, side: "A", category: "notable", confidence: "verified", durationSec: 60, spotting: "moderate", visibleWhenCloudy: true, scene: "bay",
  ...
  },
  {
    ...
    minutesFromTokyo: 31, side: "A", category: "curious", confidence: "verified", durationSec: 2, spotting: "moderate", visibleWhenCloudy: true, scene: "castle",
    ...
    photos: [
      ...
      {
        src: "images/20260820_odawara_castle_michikusa.jpg",
  ...
  },
  {
    ...
    pageTitle: {
      ja: "空へと向かう三島車両所の新幹線発射台｜カタパルトの謎 | 新幹線の窓",
      en: "Mishima's Shinkansen Catapult | The Track That Climbs into the Sky",
    },
    pageHeading: {
      ja: "空へと向かう三島車両所の新幹線発射台",
    ...
    metaDescription: {
      ja: "三島を出て新富士へ向かうA席側に、空へ伸びるような新幹線発射台が見えます。通称カタパルトの正体である三島車両所の着発線と、スイッチバックの仕組みを紹介します。",
      en: "After Mishima, elevated tracks on the Seat A side seem to climb into the sky. Learn why they are nicknamed a catapult and how the Mishima depot's switchback works.",
    },
    sectionHeading: {
      ja: "車窓から見上げるカタパルトの謎",
      en: "The mystery of Mishima's window-side catapult",
    },
    pageStory: {
      ja: "「銀河鉄道999のよう」と言いたくなる高架線は、飾りでも廃線跡でもありません。三島車両所の着発線で、実際に新幹線が使う折り返しスペースです。三島車両所は日常点検や修繕を担う中間基地。東京から来た編成は、基地へ入るためにいったん駅と反対側の西へ進み、ここで折り返して車両所へ入ります。見た目はSFでも、営業運転を支える合理的な配線なのです。",
      en: "The elevated track that looks like it belongs in science fiction is neither decoration nor an abandoned line. It is an active arrival-and-departure track at the Mishima rolling-stock depot, where Shinkansen sets reverse. The depot is a mid-route base for routine inspections and repairs. A set arriving from Tokyo first runs west, away from the station, then reverses into the depot: a thoroughly practical layout that happens to look spectacular from the window.",
    },
    explainer: {
      heading: { ja: "カタパルトの正体は？", en: "What is the “catapult” really?" },
      ja: [
        "「発射台」は正式な設備名ではなく、空へ向かうように見える着発線への愛称です。着発線は、運用を終えた編成を基地へ入れたり、整備を終えた編成を本線へ戻したりするための線路です。三島車両所は、日常点検・修繕と車両の運用を支える新幹線のバックヤードでもあります。",
        "三島車両所へ入る列車は、いったん本線の西側にある着発線へ進み、進行方向を逆転して基地へ入ります。通り過ぎてから戻るように見えるこの動きが、基地の配置に合わせたスイッチバックです。反対に、基地から駅へ向かう編成もこの折り返しスペースを経由します。",
        "この着発線は1968年10月に造られ、1969年に開業した三島駅より少し早い施設です。新幹線1編成分の長さを西へ確保すると、その先は黄瀬川の谷。地面だけが下がっていくため、線路は必要な高さのまま橋脚の上へ延びます。",
        "つまり「線路が空へ上っている」のではなく、「地面が黄瀬川の谷へ下がっている」のです。本線から横に見ると高低差が強調され、終端が空へ飛び出すランプのように見えます。理由を知ってから見ると、SFのような姿が極めて合理的な鉄道設備に変わります。",
      ],
      en: [
        "“Catapult” is a nickname, not an official term, for arrival-and-departure tracks that look skyward. They take sets into the depot after service and return maintained sets to the main line. Mishima is also a working mid-route base for routine inspections and repairs.",
        "A train entering the Mishima depot first runs onto tracks west of the main line, then reverses into the yard. This apparent overshoot and return is a switchback shaped by the depot's layout; sets leaving the depot use the same reversal space in the other direction.",
        "The tracks were built in October 1968, shortly before Mishima Station opened in 1969. Extending them far enough for a full Shinkansen set led toward the Kise River valley, where the ground falls away while the railway has to stay high.",
        "So the track is not climbing into the sky: the ground is falling toward the valley. From the adjacent main line, that height difference exaggerates the effect and makes the end look like a launch ramp. The science-fiction view is a very practical piece of railway engineering.",
      ],
    },
    guideHighlight: {
  ...
  },
  {
    ...
    media: {
      heading: { ja: "動画で見る富士の製紙工場", en: "Fuji's Paper Mills in motion" },
      description: {
        ja: "富士山のふもとに広がる製紙工場地帯を通過する車窓を、投稿動画でも見られます。",
        en: "See Fuji City's paper mills pass beneath Mt. Fuji in this window video.",
      },
      videos: [
        {
          kind: "x",
          url: "https://x.com/yukko27681822/status/2024325906232463473",
          handle: "@yukko27681822",
          accessibleTitle: { ja: "富士の製紙工場のX動画", en: "X video of Fuji's paper mills" },
          fallbackText: { ja: "新富士手前の製紙工場地帯を写した車窓動画", en: "Window video of the paper mills just before Shin-Fuji" },
        },
        {
          kind: "x",
          url: "https://x.com/heartwitt/status/1369529916513939458",
          handle: "@heartwitt",
          accessibleTitle: { ja: "富士山と製紙工場のX動画", en: "X video of Mt. Fuji and the paper mills" },
          fallbackText: { ja: "富士山と製紙工場のコントラストを捉えた車窓動画", en: "Window video capturing the contrast between Mt. Fuji and the paper mills" },
          comment: { ja: "富士山と工場とのコントラスト", en: "The contrast between Mt. Fuji and the paper mills." },
        },
      ],
    ...
    photoCredit: {
      ja: "@OliverinJapan",
      en: "@OliverinJapan",
      url: "https://x.com/OliverinJapan/status/1862487767814738420",
      date: "2024-11-29",
      note: { ja: "赤白の煙突と富士山が重なる、富士の製紙工場", en: "Fuji's paper mills, with the red-and-white chimney framing Mt. Fuji." },
    },
    photos: [
      {
  ...
  },
  {
    ...
    minutesFromTokyo: 50, side: "A", category: "notable", confidence: "source-backed", durationSec: 5, spotting: "moderate", visibleWhenCloudy: true, scene: "bay",
    ...
    media: {
      ...
      description: { ja: "清水港のクレーンと、白い掘削やぐらを掲げる「ちきゅう」を、投稿動画でも確かめられます。", en: "See Shimizu Port's cranes and CHIKYU's white drilling derrick in motion." },
      videos: [
        {
          kind: "youtube",
          id: "rUHTtSjrr7U",
          title: { ja: "清水港とちきゅうの車窓動画 1", en: "Shimizu Port and CHIKYU window video 1" },
          url: "https://www.youtube.com/watch?v=rUHTtSjrr7U",
        },
        {
          kind: "youtube",
          id: "MbiVkPPQaOw",
          title: { ja: "清水港とちきゅうの車窓動画 2", en: "Shimizu Port and CHIKYU window video 2" },
          url: "https://www.youtube.com/watch?v=MbiVkPPQaOw",
        },
        {
          kind: "x",
          url: "https://x.com/tomo370/status/1788563724166746292",
          handle: "@tomo370",
          accessibleTitle: { ja: "清水港とちきゅうのX動画 3", en: "Third X video of Shimizu Port and CHIKYU" },
          fallbackText: { ja: "清水港とちきゅうを通過する車窓動画", en: "Passing Shimizu Port and CHIKYU from the Shinkansen window" },
        },
        {
          kind: "x",
          url: "https://x.com/Carmisatasvin/status/2033507101855842753",
          handle: "@Carmisatasvin",
          accessibleTitle: { ja: "清水港とちきゅうのX動画 4", en: "Fourth X video of Shimizu Port and CHIKYU" },
          fallbackText: { ja: "清水港の車窓とちきゅうを写した投稿動画", en: "A window view of Shimizu Port and CHIKYU" },
        },
        {
          kind: "x",
          url: "https://x.com/SDmeTV6NPq0xWMI/status/1766963730494181879",
          handle: "@SDmeTV6NPq0xWMI",
          orientation: "portrait",
          accessibleTitle: { ja: "清水港とちきゅうのX動画 5", en: "Fifth X video of Shimizu Port and CHIKYU" },
          fallbackText: { ja: "港のクレーン越しに見るちきゅうの車窓動画", en: "CHIKYU seen beyond the port cranes" },
        },
        {
          kind: "x",
          url: "https://x.com/keaton_n18/status/1807362136295051274",
          handle: "@keaton_n18",
          orientation: "portrait",
          accessibleTitle: { ja: "清水港とちきゅうのX動画 6", en: "Sixth X video of Shimizu Port and CHIKYU" },
          fallbackText: { ja: "新幹線から見える清水港とちきゅうの車窓動画", en: "Shimizu Port and CHIKYU from the Shinkansen window" },
        },
      ],
      platformNote: { ja: "動画はX・YouTubeの公式埋め込みを利用しています。", en: "These videos use official X and YouTube embeds." },
    },
  ...
  },
  {
    ...
    explainer: {
      ...
      ja: [
        ...
        "夜のライトアップは、掛川桜の時期（2月下旬〜3月中旬）や、8月の「水の週間」に合わせた青色の点灯など、期間を区切って行われるものが確認できています。これとは別に、2026年9月11日の夜にも天守が点灯しているのを下りの車窓から確認しました。ただし通年で毎晩点灯しているかどうかは公式の一次情報で確認できていないため、夜に狙う場合は事前に掛川城の公式案内を見てください。",
      ],
      en: [
        ...
        "Evening light-ups are seasonal here. What can be confirmed are the Kakegawa cherry blossom period from late February to mid-March, and a blue illumination during Water Week in early August. Outside those periods, we also saw the keep lit from a westbound train on the night of 11 September 2026. Whether it is lit every night year-round is still not confirmed by a primary source, so check the castle's official information before counting on it after dark.",
      ],
    },
    guideHighlight: {
    ...
    photos: [
      ...
      {
        src: "images/20260911_kakegawa_castle_night_michikusa.jpg",
        timeOfDay: "night",
        alt: { ja: "夜の車窓からライトアップされて見える掛川城の天守", en: "Kakegawa Castle's keep lit up, seen from the train at night" },
        credit: { ja: "michikusa", en: "michikusa" },
        date: "2026-09-11",
  ...
  },
  {
    ...
    minutesFromTokyo: 73, side: "E", sideLabel: { ja: "A席・E席", en: "Seats A and E" }, category: "classic", confidence: "verified", durationSec: 90, spotting: "easy", visibleWhenCloudy: true, scene: "lake",
  ...
  },
  {
    ...
    explainer: {
      ...
      ja: [
        ...
        "チャートは、放散虫などの微生物の殻が海底に降り積もってできた、二酸化ケイ素を90%以上含む硬い堆積岩です。硬いぶん侵食に強く、まわりのやわらかい地層が削られてもチャートだけが残り、崖や岩峰になることがよく知られています。立岩の南面が林の上へ突き出して見える形も、この性質から説明されることの多いものです。数十秒で通り過ぎる灰色の壁は、そういう時間のかかり方でできています。",
      ],
      en: [
        ...
        "Chert is a hard sedimentary rock, more than 90 percent silica, formed as the remains of radiolarians and other microscopic organisms settled on the sea floor. Because it resists erosion far better than softer surrounding rock, chert commonly survives as crags and cliffs after its surroundings have worn away. That property is the usual explanation for a bare face standing above woodland, as it does here. The grey wall you pass in a few seconds was shaped on that timescale.",
      ],
    },
    guideHighlight: {
    ...
    photos: [
      ...
      {
        src: "images/20260628_toyohashi_tateiwa_michikusa.jpg",
        alt: { ja: "車窓から見える豊橋の立岩", en: "Toyohashi Tateiwa Rock from the train window" },
        credit: { ja: "michikusa", en: "michikusa" },
        date: "2026-06-28",
      },
  ...
  {
    id: "nonhoi-park-wheel",
    icon: "🎡",
    ja: { name: "のんほいパークの観覧車", area: "浜松 → 豊橋", hook: "豊橋の手前に、白い輪。", story: "浜松を出て豊橋へ向かう終盤、A席側の住宅と工場の屋根の向こうに、白い観覧車が立っています。豊橋総合動植物公園「のんほいパーク」の大観覧車です。高さは約50m、ゴンドラは6人乗りで、一周はおよそ12分。まわりに高い建物がない平地なので、空を背にした輪の形だけがすっと抜けて見えます。のんほいパークは動物園・植物園・自然史博物館・遊園地の4つをひとつにした39.6haの公園で、1992年に今の総合公園として開園しました。愛称の「のんほい」は、東三河の方言「のん」「ほい」から。東海道新幹線で最初に出会う観覧車であり、まもなく豊橋、という合図でもあります。" },
    en: { name: "The Nonhoi Park Ferris Wheel", area: "Hamamatsu → Toyohashi", hook: "A white ring before Toyohashi.", story: "In the last minutes before Toyohashi, a white Ferris wheel stands beyond the houses and factory roofs on the Seat A side. It belongs to Nonhoi Park, the combined zoo, botanical garden, natural history museum and amusement park that Toyohashi opened in its present form in 1992. The wheel is about 50 metres tall, each gondola holds six people, and a full turn takes twelve minutes. Nothing around it comes close to that height, so on this wide, flat plain the ring simply lifts clear of the rooftops against the sky. It is the first of the Ferris wheels you meet on the Tokaido Shinkansen, and a reliable sign that Toyohashi is about a minute away." },
    pageTitle: {
      ja: "新幹線から見えるのんほいパークの観覧車｜浜松〜豊橋のA席で探す | 新幹線の窓",
      en: "The Nonhoi Park Ferris Wheel from the Shinkansen | Spotting It from Seat A | Shinkansen Window",
    },
    pageHeading: {
      ja: "豊橋の手前に立つ、のんほいパークの大観覧車",
      en: "The Nonhoi Park wheel, just before Toyohashi",
    },
    pageHeadingChunks: {
      ja: ["豊橋の手前に立つ、", "のんほいパークの大観覧車"],
      en: ["The Nonhoi Park wheel,", "just before Toyohashi"],
    ...
    metaDescription: {
      ja: "東海道新幹線の浜松〜豊橋、A席側に見えるのんほいパーク（豊橋総合動植物公園）の大観覧車。高さ約50m、線路からは約0.6kmと近く、屋根の上に輪だけが抜けて見えます。見えるタイミングと見つけ方を車窓写真と地図で解説します。",
      en: "Between Hamamatsu and Toyohashi, the Seat A side shows the 50-metre Ferris wheel at Nonhoi Park. It stands just 0.6 km from the line, so the ring lifts clear of the rooftops. When to watch, how to find it, with a window photo and a map.",
    },
    sectionHeading: {
      ja: "のんほいパークは、どんな公園？",
      en: "What is Nonhoi Park?",
    },
    pageStory: {
      ja: "のんほいパークの正式名称は豊橋総合動植物公園。動物園・植物園・自然史博物館・遊園地の4つのゾーンを、39.6haというひとつの敷地に収めた公園です。歴史は意外に古く、前身は1899年（明治32年）に豊橋駅前で開かれた個人経営の「安藤動物園」。1954年に豊橋公園内で豊橋動物園として再開園し、1970年に現在地へ移って豊橋子供自然公園となりました。1988年5月には自然史博物館が開館し、1992年4月29日、これらを統合した総合公園として今の形で開園しています。自然史博物館はエドモントサウルスの実物化石やティラノサウルスの標本を持ち、動物園のついでに入る施設という規模ではありません。愛称の「のんほい」は、東三河地方の方言に由来します。「のん」は「〜だよね」にあたる語尾、「ほい」は「やあ」「おい」と呼びかける言葉。地元の言葉をそのまま園の名前にしてしまった、その率直さが名前に残っています。車窓から見えている大観覧車も1992年から動いているので、この公園そのものと同い年です。",
      en: "Nonhoi Park is officially the Toyohashi Zoo and Botanical Park, and it packs four separate institutions — a zoo, a botanical garden, a natural history museum and a small amusement park — into a single 39.6-hectare site. Its lineage runs back further than that suggests. The first ancestor was a privately owned menagerie opened in front of Toyohashi Station in 1899, unusual for its time; it reopened inside Toyohashi Park as a municipal zoo in 1954, moved to the present site in 1970, and gained a natural history museum in 1988. The four parts were finally unified into the park you see today on 29 April 1992. The museum is no afterthought: it holds a genuine Edmontosaurus fossil alongside its Tyrannosaurus material. As for the name, 'nonhoi' is not a word in standard Japanese at all. It is two pieces of the local Higashi-Mikawa dialect — 'non', a sentence ending roughly like 'isn't it', and 'hoi', a call to get someone's attention. The city named its flagship park in its own accent. The Ferris wheel you can see from the train has been turning since 1992, exactly as long as the park itself.",
    },
    explainer: {
      heading: { ja: "見つけ方と、窓に写るもの", en: "How to find it, and what else is in the frame" },
      ja: [
        "浜松を出ておよそ7分半、豊橋到着の1分半ほど前に、A席側に現れます。線路からの距離は約0.65kmと、このあたりの車窓としてはかなり近い部類です。遠くを探すのではなく、窓のやや低いところ、屋根のすぐ上あたりに視線を置いてください。",
        "手がかりは、まわりに競合するものが何もないことです。このあたりは住宅と工場が低く広がる平地で、50mの高さに届くものが観覧車以外にありません。白い骨組みが空に直接抜けるので、曇りの日でも輪の形そのものは見分けられます。",
        "近いぶん、現れてから通り過ぎるまでが速い一景でもあります。おおよそ8秒ほど。少し手前の76分すぎにはE席側で豊橋の立岩が見えるので、どちらを狙うかを先に決めておくと、両方に気を取られて両方とも逃す、という失敗を避けられます。",
        "東京行きの列車では順番が逆になり、豊橋を出て1分半ほどで同じ輪が現れます。席側はどちらの向きでもA席側のままです。",
      ],
      en: [
        "It appears on the Seat A side about seven and a half minutes after Hamamatsu, roughly ninety seconds before you reach Toyohashi. The wheel is only about 0.65 km from the line — close, by the standards of this stretch — so look low, just above the rooftops, rather than scanning the horizon.",
        "What makes it easy is the absence of competition. This is a wide, flat plain of low houses and factory sheds, and nothing else here reaches fifty metres. The pale frame stands directly against the sky, so even on an overcast day the shape of the ring still reads.",
        "Being close also means it goes by quickly — around eight seconds. About a minute earlier, the Tateiwa rock at Toyohashi shows on the opposite, Seat E side, so decide which one you are watching for before either arrives.",
        "On a Tokyo-bound train the order reverses and the wheel comes about ninety seconds after leaving Toyohashi. The seat side does not change: it is Seat A in both directions.",
      ],
    },
    guideHighlight: {
      ja: "豊橋に着く少し前、A席側の屋根のすぐ上に白い輪が抜けて見えます。近いので現れてから消えるまでが速く、浜松を出て7分を過ぎたら窓の低めを見ておくと確実です。",
      en: "Shortly before Toyohashi, a white ring lifts clear of the rooftops on the Seat A side. It is close, so it passes quickly — start watching low in the window about seven minutes after Hamamatsu.",
    },
    minutesFromTokyo: 77.5, side: "A", category: "notable", confidence: "verified", durationSec: 8, spotting: "easy", visibleWhenCloudy: true, scene: "solar",
    routeNote: {
      ja: "上下どちらもA席側です。東海道新幹線は編成の向きが変わらないため、A席は常に線路の南側になります。変わるのは進行方向に対する左右だけで、東京から新大阪へ向かうときは左手、新大阪から東京へ向かうときは右手です。上り列車では豊橋を出ておよそ1分半後に現れます。",
      en: "Seat A in both directions. Tokaido Shinkansen sets keep the same orientation, so Seat A is always on the southern side of the line; only its relation to your direction of travel changes — on your left toward Shin-Osaka, on your right toward Tokyo. On an eastbound train it appears about ninety seconds after leaving Toyohashi.",
    },
    image: "images/20260904_nonhoi_wheel_michikusa.jpg",
    photoCredit: {
      ja: "michikusa",
      en: "michikusa",
      note: { ja: "2026-09-04撮影。家並みと鉄塔の向こうに立つ輪", en: "Photographed on 4 September 2026: the wheel beyond houses and pylons." },
    },
    relatedSpotIds: ["toyohashi-tateiwa", "hirakata-park-wheel"],
    references: [REFERENCES.nonhoiAmusement, REFERENCES.nonhoiParkOfficial, REFERENCES.nonhoiParkWiki],
    map: { lat: 34.72111, lng: 137.43194, ja: "のんほいパーク（豊橋総合動植物公園）", en: "Nonhoi Park (Toyohashi Zoo and Botanical Park)" },
    viewpoint: { lat: 34.726676, lng: 137.434016 },
  },
  {
    id: "laguna-wheel",
    icon: "🎡",
    ja: { name: "ラグーナテンボスの観覧車", area: "豊橋 → 三河安城", hook: "海辺の街に、大きな輪。", story: "豊橋を出て三河安城へ向かう途中、A席側に大きな白い輪が立ちます。蒲郡の海辺にあるラグーナテンボスの観覧車です。高さは65m、ゴンドラは4人乗りで、頂上からは三河湾が一望できます。線路からは約0.8km。集合住宅や畑の向こうに立っていますが、まわりの建物よりずっと高く出るので、探すというより目に入ってくる輪です。夜はイルミネーションが灯り、暗い海辺に光の輪が浮かびます。この観覧車を見送った30秒ほどあとには、同じA席側の遠くに三河湾と三河大島が現れます。海側の窓がいちばん楽しい区間です。" },
    en: { name: "The Laguna Ten Bosch Ferris Wheel", area: "Toyohashi → Mikawa-Anjo", hook: "A big wheel by the sea.", story: "Between Toyohashi and Mikawa-Anjo, a large white wheel rises on the Seat A side. This is the Ferris wheel at Laguna Ten Bosch, on the coast at Gamagori: 65 metres tall, four to a gondola, with the whole of Mikawa Bay laid out from the top. It stands about 0.8 km from the line, beyond apartment blocks and fields, but it clears everything around it so comprehensively that you do not really have to look for it. After dark it is lit, and the ring floats above the coast. Keep watching the same window afterwards: about half a minute later, Mikawa Bay and the gourd-shaped island of Mikawa Oshima appear in the distance. This is the stretch where the sea side earns its keep." },
    pageTitle: {
      ja: "新幹線から見えるラグーナテンボスの観覧車｜豊橋〜三河安城のA席で探す | 新幹線の窓",
      en: "The Laguna Ten Bosch Ferris Wheel from the Shinkansen | Spotting It from Seat A | Shinkansen Window",
    },
    pageHeading: {
      ja: "蒲郡の海辺に立つ、高さ65mの観覧車",
      en: "A 65-metre wheel on the Gamagori coast",
    },
    pageHeadingChunks: {
      ja: ["蒲郡の海辺に立つ、", "高さ65mの観覧車"],
      en: ["A 65-metre wheel", "on the Gamagori coast"],
    ...
    metaDescription: {
      ja: "東海道新幹線の豊橋〜三河安城、A席側に見えるラグーナテンボスの観覧車。高さ65m・4人乗りで、三河湾を望む蒲郡の海辺に立ちます。線路からの距離、見えるタイミング、直後に現れる三河大島との関係を車窓写真と地図で解説します。",
      en: "Between Toyohashi and Mikawa-Anjo, the Seat A side shows the 65-metre Ferris wheel at Laguna Ten Bosch on the Gamagori coast. Its distance from the line, when to watch, and the island that follows it half a minute later.",
    },
    sectionHeading: {
      ja: "ラグーナテンボスは、どんな場所？",
      en: "What is Laguna Ten Bosch?",
    },
    pageStory: {
      ja: "ラグーナテンボスは、蒲郡市海陽町にある海辺のリゾートです。中心となるテーマパーク「ラグナシア」は2002年（平成14年）4月25日、ラグーナ蒲郡として開業しました。埋め立てた海辺にテーマパーク、マリーナ、商業施設「フェスティバルマーケット」を組み合わせた複合開発で、2014年以降はHISグループのもとでラグーナテンボスという名前になっています。名前の「テンボス」は、同じグループが運営するハウステンボスと同系の呼び名です。車窓から見える観覧車は高さ65m、4人乗りのゴンドラで、公式には三河湾が一望でき、夜のイルミネーションも華やかな乗り物として紹介されています。つまりこれは、海を眺めるために建てられた観覧車です。新幹線の側からはその背中を、内陸から見ていることになります。観覧車の向こう側、ゴンドラに乗っている人たちが見ているのは、こちらからは建物に隠れて見えない三河湾のほうです。",
      en: "Laguna Ten Bosch is a seaside resort complex in Gamagori, built out onto reclaimed land on Mikawa Bay. Its centrepiece theme park, Lagunasia, opened on 25 April 2002 as Laguna Gamagori, combining rides with a marina and a shopping and dining quarter. Since 2014 it has been run by the HIS group, which also operates Huis Ten Bosch in Nagasaki — hence the shared 'Ten Bosch' in the name. The Ferris wheel is 65 metres tall and carries four to a gondola, and the operator describes it as a ride with a panorama of Mikawa Bay and a lavish illumination after dark. That is worth holding onto as you pass, because it means the wheel was built to face the water. From the Shinkansen you are looking at its landward side. The people in those gondolas are looking at a bay that the buildings in front of you hide completely.",
    },
    explainer: {
      heading: { ja: "見つけ方と、そのすぐあとに来るもの", en: "How to find it, and what comes next" },
      ja: [
        "豊橋を出ておよそ3分、東京からは82分あたりのA席側です。線路からの距離は約0.8km。手前には集合住宅や畑があり、視界をさえぎるものが全くないわけではありませんが、65mという高さがそれを問題にしません。屋根の上にはっきり突き出た輪を探してください。",
        "同じ観覧車でも、豊橋の手前で見えるのんほいパーク（約50m・約0.65km）とは見え方が違います。あちらは低い屋根の上に輪だけが浮かぶ景色、こちらは街並みの上に構造物としてそびえる景色です。2つを続けて見ると、高さの差がそのまま見え方の差になっていることが分かります。",
        "見送ったあとも、窓はそのままにしておいてください。30秒ほどあとの82分半ごろ、同じA席側の遠くに三河湾と三河大島が現れます。ひょうたん型の無人島で、見通しの良い日にしか出てきません。観覧車と島は、同じ蒲郡の海を別の距離で見ている一景です。",
        "夜はイルミネーションが灯るので、暗くなってからの列車のほうが見つけやすくなります。ただし手前の街の明かりも同時に増えるため、昼のような輪郭のはっきりした見え方にはなりません。",
      ],
      en: [
        "It comes about three minutes after Toyohashi, some 82 minutes out of Tokyo, on the Seat A side. The wheel sits roughly 0.8 km from the line. Apartment blocks and fields stand in front of it, but 65 metres is enough to make that irrelevant — look for a ring standing clearly above the rooflines.",
        "It reads quite differently from the Nonhoi Park wheel you passed a few minutes earlier, which is about 50 metres tall and 0.65 km away. That one floats as a ring above low roofs; this one rises over the town as a structure. Seeing the two in quick succession is a neat demonstration of how much height changes a distant view.",
        "Do not look away once it has gone. About thirty seconds later, in the same window, Mikawa Bay opens up with the uninhabited, gourd-shaped island of Mikawa Oshima on the horizon — visible only when the air is clear. The wheel and the island are the same stretch of Gamagori coast seen at two different distances.",
        "After dark the wheel is illuminated, which makes it easier to catch, though the town lights in front of it multiply at the same time and the outline is never as clean as it is by day.",
      ],
    },
    guideHighlight: {
      ja: "豊橋を出て3分ほど、A席側の街並みの上に大きな輪がそびえます。高さ65mあるので手前の建物に負けません。見送ったあとも窓はそのままに、30秒後に同じ側の遠くへ三河大島が出てきます。",
      en: "About three minutes after Toyohashi, a large wheel rises above the town on the Seat A side; at 65 metres it beats everything in front of it. Keep the same window afterwards — Mikawa Oshima appears in the distance half a minute later.",
    },
    minutesFromTokyo: 82, side: "A", category: "notable", confidence: "verified", durationSec: 12, spotting: "easy", visibleWhenCloudy: true, scene: "bay",
    routeNote: {
      ja: "上下どちらもA席側です。東海道新幹線は編成の向きが変わらないため、A席は常に線路の南側になります。変わるのは進行方向に対する左右だけで、東京から新大阪へ向かうときは左手、新大阪から東京へ向かうときは右手です。上り列車では三河安城を出ておよそ6分後、三河大島を見送ったあとに現れます。",
      en: "Seat A in both directions. Tokaido Shinkansen sets keep the same orientation, so Seat A is always on the southern side of the line; only its relation to your direction of travel changes — on your left toward Shin-Osaka, on your right toward Tokyo. Eastbound it comes about six minutes after Mikawa-Anjo, just after Mikawa Oshima has passed.",
    },
    image: "images/20260820_laguna_wheel_michikusa.jpg",
    photoCredit: {
      ja: "michikusa",
      en: "michikusa",
      note: { ja: "2026-08-20撮影。街並みの向こうに立つ輪", en: "Photographed on 20 August 2026: a white wheel beyond the town." },
    },
    relatedSpotIds: ["mikawa-oshima", "nonhoi-park-wheel"],
    references: [REFERENCES.lagunasiaOfficial, REFERENCES.lagunasiaWiki],
    map: { lat: 34.807722, lng: 137.27583, ja: "ラグーナテンボス", en: "Laguna Ten Bosch" },
    viewpoint: { lat: 34.814945, lng: 137.276134 },
  },
  {
    id: "mikawa-oshima",
    icon: "🏝️",
    ...
    photos: [
      ...
      {
        src: "images/20260820_mikawa_oshima_1_michikusa.jpg",
  ...
  {
    id: "horiuchi-park-wheel",
    icon: "🎡",
    ja: { name: "堀内公園の観覧車", area: "豊橋 → 三河安城", hook: "住宅地の奥に、小さな輪。", story: "三河安城に着く1分ほど前、A席側の住宅地の奥に、小さな観覧車が見えます。安城市の堀内公園です。「花とみどりとメルヘン」をテーマにした市営の公園で、入園は無料。汽車のメルヘン号、メリーゴーランド、サイクルモノレール、そしてこの観覧車が、どれも1回100円前後で動いています。遊園地というより、観覧車のある公園。少し前に見えるラグーナテンボスの輪（65m）にくらべるとずっと低く、屋根や電柱に紛れやすい対象です。線路からは約0.45kmと3基のなかでいちばん近いのに、いちばん見つけにくい——そういう小ささが、この輪の性格です。" },
    en: { name: "The Horiuchi Park Ferris Wheel", area: "Toyohashi → Mikawa-Anjo", hook: "A small ring beyond the houses.", story: "About a minute before Mikawa-Anjo, a small Ferris wheel shows beyond the houses on the Seat A side. It belongs to Horiuchi Park, a free municipal park in Anjo built around the theme of flowers, greenery and fairy tales. A little train, a carousel, a cycle monorail and this wheel all run for around a hundred yen a ride. It is less an amusement park than a park that happens to have a Ferris wheel. Compared with the 65-metre wheel at Laguna Ten Bosch a few minutes earlier it is much lower, and it hides easily among roofs and power poles. At about 0.45 km it is the closest of the three wheels on this stretch and still the hardest to find — which is rather the point of it." },
    pageTitle: {
      ja: "新幹線から見える堀内公園の観覧車｜三河安城の手前・A席で探す | 新幹線の窓",
      en: "The Horiuchi Park Ferris Wheel from the Shinkansen | A Small Ring before Mikawa-Anjo | Shinkansen Window",
    },
    pageHeading: {
      ja: "三河安城の手前、屋根に紛れる小さな輪",
      en: "A small ring beyond the houses before Mikawa-Anjo",
    },
    pageHeadingChunks: {
      ja: ["三河安城の手前、", "屋根に紛れる小さな輪"],
      en: ["A small ring beyond the houses", "before Mikawa-Anjo"],
    ...
    metaDescription: {
      ja: "東海道新幹線の豊橋〜三河安城、A席側の住宅地の奥に見える安城市・堀内公園の観覧車。線路から約0.45kmと近いのに小さく、見つけるのが難しい一景です。見えるタイミングと探し方を車窓写真と地図で解説します。",
      en: "Before Mikawa-Anjo, a small Ferris wheel at Anjo's Horiuchi Park shows beyond the houses on the Seat A side. Only 0.45 km from the line and still easy to miss — when to watch and what to look for.",
    },
    sectionHeading: {
      ja: "堀内公園は、どんな公園？",
      en: "What is Horiuchi Park?",
    },
    pageStory: {
      ja: "堀内公園は、安城市堀内町にある市営の公園です。テーマは「花とみどりとメルヘン」。園内には観覧車のほかに、汽車のメルヘン号、メリーゴーランド、サイクルモノレール、無料で遊べるふわふわドームや芝すべり、ちびっこサーキット、それにバードハウスや芝生広場、やすらぎの池があります。入園は無料で、有料の乗り物も1回100円前後。子どもを半日遊ばせるための場所として、地元では定番の公園です。車窓から見る側の事情でいえば、これは「観覧車が小さいこと」に理由がある景色でもあります。集客のためのランドマークとして建てられた観覧車ではなく、公園の遊具のひとつとして置かれた観覧車だからです。ラグーナテンボスの65mが海を見るための高さだとすれば、こちらは公園をひと回りするための高さ。だから新幹線からは、住宅地の屋根に半分埋もれたような見え方になります。見つけにくさそのものが、この公園の性格を言い当てている、とも言えます。",
      en: "Horiuchi Park is a municipal park in Anjo, built around the theme of flowers, greenery and fairy tales. Alongside the Ferris wheel there is a little train called the Märchen, a carousel, a cycle monorail, an air dome, a grass slide and a small circuit for children, plus a bird house, a lawn and a pond. Admission is free and the rides cost around a hundred yen each. It is the sort of place a family takes over for an afternoon. That ordinariness is exactly why the view from the train is what it is. This wheel was never built as a landmark to draw crowds from a distance; it was installed as one more piece of park equipment. Where the 65 metres at Laguna Ten Bosch buys a view of the bay, this height buys a look across a park. Which is why, from the Shinkansen, the ring sits half-buried among the rooftops of an ordinary suburb. Its difficulty is not a flaw in the view — it is the view telling you what kind of place this is.",
    },
    explainer: {
      heading: { ja: "見つけ方と、勘違いしやすいもの", en: "How to find it, and what it is not" },
      ja: [
        "東京から87分あたり、三河安城に着く1分ほど前のA席側です。線路からは約0.45kmで、このあたりの車窓ではいちばん近い対象のひとつ。それでも難しいのは、輪が小さく、手前の住宅の屋根や電柱と同じ高さの帯に入ってしまうからです。",
        "空を背にした輪を探すつもりだと見つかりません。屋根の並びのなかに、格子の丸いものが混じっていないかを探してください。晴れて光が回っている時間帯のほうが、骨組みの影が出て輪郭を拾いやすくなります。",
        "見えている時間は5秒ほどです。数分前に大きなラグーナテンボスの観覧車を見送っているので、同じ大きさを期待していると通り過ぎます。まったく別のサイズのものが来る、と思って待つのがいちばん確実です。",
        "この直後、三河安城のあたりでは反対のE席側に、工場の壁いっぱいのセロテープ看板が現れます。A席で輪を探し、E席で看板を見る。短い区間に左右ひとつずつ、性格の違う車窓が並んでいます。",
      ],
      en: [
        "It comes about 87 minutes out of Tokyo, roughly a minute before Mikawa-Anjo, on the Seat A side. At 0.45 km it is one of the closest things you will look at along here — and still one of the hardest, because the ring is small enough to sit in the same band of the window as the roofs and power poles in front of it.",
        "Do not look for a ring against the sky; you will not find one. Look instead for something round and latticed mixed in among the rooflines. Bright, high light helps, because the frame then throws enough shadow to separate itself from what is behind it.",
        "You have about five seconds. If you watched the large Laguna Ten Bosch wheel a few minutes earlier, adjust your expectations before this one arrives — it is a completely different size, and looking for the same thing twice is the usual reason people miss it.",
        "Immediately afterwards, near Mikawa-Anjo, the opposite Seat E side gets the giant CELLOTAPE advertisement painted across a factory wall. A ring on one side, a wall on the other, within about a minute of each other.",
      ],
    },
    guideHighlight: {
      ja: "三河安城に着く1分ほど前、A席側の住宅の屋根の並びに小さな輪が混じります。空ではなく屋根の高さを探してください。ラグーナの大きな観覧車と同じつもりで待つと通り過ぎます。",
      en: "About a minute before Mikawa-Anjo, a small ring hides among the rooflines on the Seat A side. Search the roofs, not the sky — and do not expect anything like the big Laguna wheel you passed a few minutes earlier.",
    },
    minutesFromTokyo: 87, side: "A", category: "curious", confidence: "verified", durationSec: 5, spotting: "moderate", visibleWhenCloudy: true, scene: "hills",
    routeNote: {
      ja: "上下どちらもA席側です。東海道新幹線は編成の向きが変わらないため、A席は常に線路の南側になります。変わるのは進行方向に対する左右だけで、東京から新大阪へ向かうときは左手、新大阪から東京へ向かうときは右手です。上り列車では三河安城を出ておよそ1分後に現れます。",
      en: "Seat A in both directions. Tokaido Shinkansen sets keep the same orientation, so Seat A is always on the southern side of the line; only its relation to your direction of travel changes — on your left toward Shin-Osaka, on your right toward Tokyo. Eastbound it appears about a minute after leaving Mikawa-Anjo.",
    },
    image: "images/20260820_horiuchi_wheel_michikusa.jpg",
    photoCredit: {
      ja: "michikusa",
      en: "michikusa",
      note: { ja: "2026-08-20撮影。住宅地の奥に小さく見える輪", en: "Photographed on 20 August 2026: a small wheel beyond the houses." },
    },
    relatedSpotIds: ["nichiban-anjo", "laguna-wheel"],
    references: [REFERENCES.horiuchiParkAnjo, REFERENCES.horiuchiParkAichiNow],
    map: { lat: 34.9288139, lng: 137.0912944, ja: "堀内公園", en: "Horiuchi Park" },
    viewpoint: { lat: 34.931254, lng: 137.095191 },
  },
  {
    id: "nichiban-anjo",
    icon: "🟦",
  ...
  },
  {
    ...
    minutesFromTokyo: 103, side: "E", category: "notable", confidence: "verified", durationSec: 5, spotting: "easy", visibleWhenCloudy: true, scene: "solar",
  ...
  },
  {
    ...
    ja: {
      ...
      area: "岐阜羽島駅",
      hook: "岐阜なのにハワイ？",
      story: "岐阜羽島駅に差しかかるA席側、ホームの向こうに「MaHaLo」の大きな文字が現れます。マハロは、羽島市に本社を置く高陽社が販売する、ハワイ島コナ沖で取水した海洋深層水の商品名です。海から遠い岐阜の田園に突然ハワイ語が現れるように見えて、実は販売元のお膝元。ホーム、線路、空と一緒に一枚の景色へ入るので、通過の短さに比べて強く印象に残ります。",
    },
    en: {
      name: "Mahalo Sign at Gifu-Hashima",
      area: "Gifu-Hashima Station",
      hook: "Hawaiʻi in inland Gifu?",
      story: "At Gifu-Hashima, large letters reading 'MaHaLo' appear beyond the platform on the Seat A side. Mahalo is the name of deep-ocean water drawn off Kona, Hawaiʻi, and sold by Koyo-sha, whose headquarters are in Hashima. It seems like Hawaiian suddenly appearing in inland Gifu, but this is the seller's home ground. Platform, tracks, sky, and billboard enter one frame, making it memorable despite the brief passage.",
    },
    pageTitle: {
      ja: "岐阜羽島に立つマハロの巨大看板｜岐阜なのにハワイ？ | 新幹線の窓",
      en: "Mahalo's Giant Sign at Gifu-Hashima | Hawaiʻi in inland Gifu?",
    },
    pageHeading: {
      ja: "岐阜羽島に立つマハロの巨大看板",
      en: "Mahalo's giant sign at Gifu-Hashima",
    },
    pageHeadingChunks: {
      ja: ["岐阜羽島に立つ", "マハロの巨大看板"],
      en: ["Mahalo's giant sign", "at Gifu-Hashima"],
    ...
    sectionHeading: {
      ja: "岐阜なのにハワイ？ 巨大看板の正体",
      en: "Hawaiʻi in inland Gifu? The giant sign explained",
    },
    pageStory: {
      ja: "岐阜羽島駅を通過するA席側の車窓に、海洋深層水を掲げるMaHaLoの大きな看板があります。商品はハワイ島コナ沖で取水され、高陽社が2003年から販売しているものです。高陽社は1998年に本社を羽島へ移しており、海から遠い新幹線駅のホーム越しにハワイ語と深海の水が現れる意外さは、まさに販売元のお膝元だからこそ生まれた景色です。",
      en: "On the Seat A side as the train passes Gifu-Hashima, a large MaHaLo sign promotes deep-ocean water. The water is drawn off Kona, Hawaiʻi, and has been sold by Koyo-sha since 2003. The company moved its headquarters to Hashima in 1998, so this surprising collision of Hawaiian, deep-ocean water, and an inland Shinkansen platform exists precisely in the seller's home town.",
    },
    explainer: {
      heading: { ja: "海から遠い岐阜羽島に、なぜ海洋深層水？", en: "Why deep-ocean water in inland Gifu-Hashima?" },
      ja: [
        "MaHaLo（マハロ）は、ハワイ島コナ沖で取水する海洋深層水の商品名です。「Mahalo」はハワイ語で感謝を表す言葉として知られます。岐阜の田園にハワイ語が立つように見えて、販売する高陽社は羽島市に本社を置きます。看板は、遠い海の水と地元企業を一瞬でつなぐ目印です。",
        "高陽社は1972年に東京で創業し、1994年に羽島市へ研修センターを開き、1996年にホテルKOYO、1998年に本社を移しました。2003年にMaHaLoの販売を始めています。巨大な看板は、商品を説明するより先に「羽島に高陽社がある」と伝える、販売元の沿線サインでもあります。",
        "高陽社の2011年の広報誌には、岐阜羽島駅前の写真とともに「車窓からの景色が、この水との出会いでした。」というコピーが載っています。つまり、この看板はたまたま線路際にあるのではなく、新幹線の車窓で見つけられることを会社自身が表現に取り込んできたものです。",
        "新幹線からは小さな説明文を読む余裕がありません。だから沿線には、727のように商品名や会社名だけを極端に大きく掲げる野立て看板が残ります。MaHaLoの大きさも、時速200km超で通過する乗客へのメッセージ。ホーム越しに大きな文字だけをまず見つければ、この広告の設計そのものを体験できます。",
      ],
      en: [
        "MaHaLo is the name of deep-ocean water drawn off Kona, Hawaiʻi. 'Mahalo' is widely known as a Hawaiian word expressing thanks. The sign looks like Hawaii has appeared in the Gifu countryside, but Koyo-sha, the seller, is headquartered in Hashima. It connects a faraway ocean with a local company in a single glance.",
        "Koyo-sha was founded in Tokyo in 1972, opened a training centre in Hashima in 1994 and Hotel KOYO in 1996, moved its headquarters there in 1998, and began selling MaHaLo in 2003. The giant lettering works as a trackside marker for the company behind the product before it explains the product itself.",
        "A 2011 Koyo-sha magazine placed a Gifu-Hashima station image with the line, 'The view from the train window was our encounter with this water.' The billboard is therefore not merely next to the railway: being discovered from the Shinkansen window has been part of the company's own expression.",
        "At Shinkansen speed, small explanatory copy cannot work. That is why trackside billboards such as 727 reduce themselves to enormous product or company names. MaHaLo's scale is itself a message designed for a passing train — find the letters first, then notice the advertising logic behind them.",
      ],
    },
    guideHighlight: {
    ...
    photos: [
      ...
      {
        src: "images/20260906_gifu_hashima_station_michikusa.jpg",
        alt: { ja: "新幹線の車窓から見た岐阜羽島駅のホームと駅前", en: "Gifu-Hashima platform and station area from the Shinkansen window" },
        credit: { ja: "michikusa", en: "michikusa" },
        date: "2026-09-06",
  ...
  },
  {
    ...
    minutesFromTokyo: 103, side: "E", category: "curious", confidence: "source-backed", durationSec: 8, spotting: "hard", scene: "castle",
  ...
  },
  {
    ...
    minutesFromTokyo: 106, side: "E", category: "notable", confidence: "verified", durationSec: 15, spotting: "easy", visibleWhenCloudy: true, scene: "mountain",
  ...
  },
  {
    ...
    minutesFromTokyo: 110, side: "E", category: "classic", confidence: "verified", durationSec: 30, spotting: "easy", scene: "mountain",
  ...
  },
  {
    ...
    minutesFromTokyo: 123, side: "A", sideLabel: { ja: "A席側", en: "Seat A side" }, category: "notable", confidence: "verified", durationSec: 15, spotting: "easy", scene: "mountain",
  ...
  },
  {
    ...
    minutesFromTokyo: 131, side: "A", category: "classic", confidence: "verified", durationSec: 10, spotting: "moderate", visibleWhenCloudy: true, scene: "pagoda",
  ...
  },
  {
    ...
    minutesFromTokyo: 141, side: "E", category: "notable", confidence: "source-backed", durationSec: 10, spotting: "moderate", visibleWhenCloudy: true, scene: "hills",
...
const BOARD_COLLECTION = [
  ...
  { sourceNo: 26, id: "727-no-26", minutesFromTokyo: 86, segment: "豊橋 → 三河安城", side: "A", lat: 34.901211, lng: 137.120352, confidence: "verified", photo: { src: "images/20260820_727_board_shimomitsugi_michikusa.jpg", alt: "実りかけの田の向こうに立つ岡崎市下三ツ木町の727看板", note: "michikusa / 2026-08-20 · GPSログとA席側からNo.26に照合" }, ja: "下三ツ木町（岡崎市）", en: "Shimomitsugi, Okazaki" },
  ...
  { sourceNo: 28, id: "727-no-28", minutesFromTokyo: 87, segment: "豊橋 → 三河安城", side: "A", lat: 34.939159, lng: 137.086311, confidence: "verified", photo: { src: "images/20260820_727_board_koshin_michikusa.jpg", alt: "A席側から見える安城市安城町庚申の727看板", note: "michikusa / 2026-08-20 · GPSログとA席側からNo.28に照合" }, ja: "安城町庚申（安城市）", en: "Koshin, Anjo" },
  ...
  { sourceNo: 36, id: "727-no-36", minutesFromTokyo: 108, segment: "岐阜羽島 → 米原", side: "A", lat: 35.361132, lng: 136.534258, collectionNote: "南宮山をバックに", confidence: "verified", photo: { src: "images/20260820_727_board_miyashiro_a_michikusa.jpg", alt: "南宮山を背にした垂井町宮代の727看板", note: "michikusa / 2026-08-20 · 品川06:00発のぞみ99号で07:40撮影" }, collectionPhotos: [{ src: "images/20260704_727_board_miyashiro_a_michikusa.jpg", alt: "A席側から見える垂井町宮代の727看板", note: "michikusa / 2026-07-04 · 東京11:12発のぞみ27号で13:00撮影" }], ja: "宮代（垂井町）", en: "Miyashiro, Tarui" },
  ...
  { sourceNo: 38, id: "727-no-38", minutesFromTokyo: 111, segment: "岐阜羽島 → 米原", side: "A", lat: 35.357509, lng: 136.399357, confidence: "verified", photo: { src: "images/20260816_727_board_onogi_michikusa.jpg", alt: "A席側から見える米原市大野木の727看板", note: "michikusa / 2026-08-16" }, collectionPhotos: [{ src: "images/20260816_727_board_onogi_2_michikusa.jpg", alt: "続けて見える米原市大野木の727看板", note: "michikusa / 2026-08-16" }], ja: "大野木（米原市）", en: "Onogi, Maibara" },
